        ...
        <div className="min-h-full pb-24" style={{ background: 'var(--cream)' }}>
            ...
            <div className="flex items-center justify-between px-6 py-8 border-b border-aesthetic-accent/20 bg-aesthetic-cream/50 backdrop-blur-md sticky top-0 z-10 transition-all duration-500">
                <Link href="/admin/services" className="flex items-center justify-center size-10 rounded-full hover:bg-black/5 transition-colors">
                    <span className="material-symbol text-aesthetic-sage font-light">arrow_back</span>
                </Link>
                <div className="flex-1 text-center">
                    <h1 className="font-display text-xl font-medium tracking-tight text-aesthetic-forest italic">
                ...
                <main className="max-w-md mx-auto w-full px-6 py-8 space-y-10">
                    ...
                    <section className="flex flex-col items-center gap-4">
                        ...
                        >
                            {imagePreview ? (
                                ...
                                <div className="flex flex-col items-center gap-3 text-aesthetic-jade/40 group-hover:text-aesthetic-jade transition-colors">
                        ...
                        <p className="text-[11px] text-aesthetic-sage/60 text-center px-8 leading-relaxed italic font-display">Sube una foto de alta calidad para destacar tu trabajo</p>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex gap-2 p-1 bg-white/50 rounded-2xl border border-aesthetic-accent shadow-minimal">
                            <button 
                                ...
                                className={`flex-1 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all ${!isPackage ? 'bg-aesthetic-forest text-white shadow-lg' : 'text-aesthetic-sage hover:text-aesthetic-forest'}`}
                            >
                                Servicio
                            </button>
                            <button 
                        ...
                        <div className="space-y-2">
                            <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Nombre del Servicio</label>
                            <input
                                className="w-full bg-white border-none ring-1 ring-aesthetic-accent focus:ring-aesthetic-jade/30 rounded-2xl p-4 text-base font-display italic shadow-minimal transition-all placeholder:text-aesthetic-sage/30"
                        ...
                        {/* Category */}
                        <div className="space-y-2">
                            <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Categoría</label>
                            <div className="relative">
                                ...
                                <span className="material-symbol absolute right-4 top-1/2 -translate-y-1/2 text-aesthetic-sage/30 pointer-events-none">expand_more</span>
                            </div>
                        </div>

                        {/* Description */}
                        <div className="space-y-2">
                            <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Descripción</label>
                            <textarea
                                rows={4}
                                className="w-full bg-white border-none ring-1 ring-aesthetic-accent focus:ring-aesthetic-jade/30 rounded-2xl p-4 text-base font-display italic shadow-minimal transition-all resize-none placeholder:text-aesthetic-sage/30"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Precio ($)</label>
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-aesthetic-sage/40 font-display italic">$</span>
                                    <input
                                        className="w-full bg-white border-none ring-1 ring-aesthetic-accent focus:ring-aesthetic-jade/30 rounded-2xl p-4 text-base font-display italic shadow-minimal transition-all pl-8"
                                        placeholder="0.00"
                                        value={price}
                            ...
                            <div className="space-y-2">
                                <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Duración</label>
                                <div className="relative">
                                    <select
                                        className="w-full appearance-none bg-white border-none ring-1 ring-aesthetic-accent focus:ring-aesthetic-jade/30 rounded-2xl p-4 text-base font-display italic shadow-minimal transition-all pr-10"
                                        value={duration}
                                    ...
                                    <span className="material-symbol absolute right-3 top-1/2 -translate-y-1/2 text-aesthetic-sage/40 pointer-events-none text-xl">expand_more</span>
                                </div>
                            </div>
                        </div>
                        ...
                        {isPackage && (
                            <div className="space-y-4 animate-fade-in">
                                <label className="font-display text-xs font-medium tracking-wider text-aesthetic-sage ml-1 italic">Servicios Incluidos</label>
                                    ...
                                    {allServices.filter(s => !s.is_package && s.id !== id).map(s => (
                                        <button
                                            ...
                                            className={`flex items-center gap-3 p-4 rounded-2xl border transition-all ${
                                                ...
                                                ? 'bg-aesthetic-pale-jade/30 border-aesthetic-jade shadow-minimal'
                                                : 'bg-white border-aesthetic-accent/20 hover:border-aesthetic-jade/30'
                                            }`}
                                        >
                                            <div className={`size-5 rounded-full border-2 flex items-center justify-center transition-all ${
                                                includedServiceIds.includes(s.id) ? 'border-aesthetic-jade bg-aesthetic-jade' : 'border-aesthetic-accent'
                                            }`}>
                                                {includedServiceIds.includes(s.id) && <span className="material-symbol text-white text-[10px] font-bold">check</span>}
                                            </div>
                                            <div className="text-left flex-1 min-w-0">
                                                <p className="text-sm font-display italic text-aesthetic-forest truncate leading-tight">{s.name}</p>
                                                <p className="text-[10px] text-aesthetic-sage font-bold tracking-widest">{s.duration_minutes} min</p>
                                            </div>
                                        </button>
                                    ))}
                                </div>
                                {allServices.filter(s => !s.is_package && s.id !== id).length === 0 && (
                                    <p className="text-[11px] text-aesthetic-sage italic text-center py-4">No hay servicios registrados para incluir.</p>
                                )}
                            </div>
                        )}
                    </div>
                    ...
                    <section className="pt-4 pb-12">
                        <button
                            ...
                            className="w-full bg-aesthetic-jade text-white hover:bg-aesthetic-forest transition-all duration-500 py-5 rounded-3xl text-sm font-bold tracking-[0.3em] uppercase shadow-minimal active:scale-[0.98] border border-white/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {saving ? (
                        ...
                        <p className="text-center mt-8 text-aesthetic-sage/40 text-[9px] tracking-[0.3em] uppercase font-display italic">Estética & Elegancia Profesional</p>
                    </section>
                </main>
            )}
        </div>
