...
async function cleanup() {
    ...
    try {
        const clients = await (0, db_1.query)('DELETE FROM appointments');
        const staff = await (0, db_1.query)('DELETE FROM staff');
        const services = await (0, db_1.query)('DELETE FROM services');
